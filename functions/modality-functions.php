...
function modality_setup() {
	...
	/**
 	* Custom image size for footer widget.
 	*/
	add_theme_support( 'post-thumb' );
	set_post_thumbnail_size( 70, 70 ); // Unlimited height, soft crop.
...
function modality_add_script_function() {
	...
	*/
	...
	wp_enqueue_style ('bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css'); // ori: bootstrap.css
	...
	/* add other stylesheet - dev0buzz */
	wp_enqueue_style ('css-plugin-collections', get_template_directory_uri() . '/css/css-plugin-collections.css');
	wp_enqueue_style ('custom-bootstrap-margin-padding', get_template_directory_uri() . '/css/custom-bootstrap-margin-padding.css');
	wp_enqueue_style ('main-style', get_template_directory_uri() . '/css/main-style.css');

	/**
	 * Enqueue javascripts
	 */
	wp_enqueue_script('bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ),'', true); // ori: bootstrap.js | note false ==> header | true ==> footer
	...
	/* add other stylesheet - dev0buzz */
	wp_enqueue_script('google-map', 'http://maps.google.com/maps/api/js?sensor=false', array( 'jquery' ),'', true);
	wp_enqueue_script('jquery-plugin-collection', get_template_directory_uri() . '/js/jquery-plugin-collection.js', array( 'jquery' ),'', true);
	wp_enqueue_script('instagramLite', get_template_directory_uri() . '/js/instagramLite.js', array( 'jquery' ),'', true);
	wp_enqueue_script('custom', get_template_directory_uri() . '/js/custom.js', array( 'jquery' ),'', true);
	//wp_enqueue_script('themepunch', get_template_directory_uri() . '/js/revolution-slider/js/jquery.themepunch.tools.min.js', array( 'jquery' ),'', true);
	//wp_enqueue_script('themepunch.revolution', get_template_directory_uri() . '/js/revolution-slider/js/jquery.themepunch.revolution.min.js', array( 'jquery' ),'', true);
	wp_enqueue_script('custom-revslider', get_template_directory_uri() . '/js/custom-revslider.js', array( 'jquery' ),'', true);
...
function modality_add_scrollup() {
	...
	if ( $modality_theme_options['scrollup'] == 1) {
		...
		echo '<a class="back-to-top2 scrollToTop" href="#"><i class="fa fa-angle-up"></i></a>';
	}
}
