(function($) {
  ...
  /* ---------------------------------------------------------------------- */
    ...
    /* ------------------------- E1 - instagramLite-------------------------- */
    /* ---------------------------------------------------------------------- */
    function buzz_instagram() {
        var u = $('.instagram-account').text();
        var c = $('.instagram-clientid').text();
        var n = $('.instagram-count').text();
        $('.featured-gallery.style1').instagramLite({
    		username: u, // 'vapeboss.id'
    		clientID: c, //'8c1144b4c5ba4cc3a56536e374e31e6b',
    		urls: true,
    		captions: true,
    		date: true,
    		div: true,
    		...
    		success: function() {
    			...
    			//j('.tweetie').addClass("featured-gallery style1");
    		},
        ...
        $('.featured-gallery.style3').instagramLite({
    		username: u, // 'vapeboss.id'
    		clientID: c, //'8c1144b4c5ba4cc3a56536e374e31e6b',
    		urls: true,
    		captions: true,
